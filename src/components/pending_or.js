...
export class PendingOrders extends React.Component{
    render(){
        return(
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6" style = {{ marginTop: '1%' }}>
                                    ...
                                    <form action="">
                                        ...
                                        <button class="btn waves-effect waves-light right blue white-text" type="button" name="action">Ready for shipment
